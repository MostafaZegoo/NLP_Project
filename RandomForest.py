...
print("extracted and encoded")
random = RandomForestClassifier(n_estimators=70,oob_score=True,n_jobs=-1,random_state=42,max_features=None)
...
numerical_result=random.predict(tf_vector.transform(["nescafe is a product from nestle"]))
result=""
